<!-- jsfiddle link : http://jsfiddle.net/3UWk2/3/-->
...
<select size="1" id="Rank" title="" name="Rank">
    ...
    <option value="airman">Cancer7</option>
...
<div class="container">
    <div class="airman">
        <select class="second-level-select">
            ...
            <option value="basic-ore-1">Cancer1 - Level 7</option>
    ...
    <div class="senior-airman">
        <select class="second-level-select">
            ...
            <option value="omber-miner-1">Cancer2 - Level 7</option>
